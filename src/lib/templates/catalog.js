...
export const templateCatalog = [
  ...
  {
    id: 'template-03',
    renderer: 'editorial-newspaper',
    name: '电子报刊版',
    title: '电子报刊周报',
    description: '保留报刊栏栅、导读和计划版块，适合正式编排型周报。',
    accent: '#8B1A1A',
    chip: 'PRESS/03',
    focus: '适合强调版面秩序、栏目感和长文阅读体验的正式周报。',
    bestFor: '综合周报 / 编排型汇报',
    departmentTags: ['comprehensive', 'research', 'teaching', 'operations'],
    audienceTags: ['director', 'executive', 'risk'],
    moduleBlueprint: ['报头刊名', '导读摘要', '分栏正文', '风险专栏', '下周计划'],
  },
  {
    id: 'template-04',
    renderer: 'magazine',
