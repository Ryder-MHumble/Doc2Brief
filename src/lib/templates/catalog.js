...
export const templateCatalog = [
  ...
  },
  {
    ...
    name: '分屏杂志版',
    title: '分屏杂志周报',
    description: '左右分屏布局，左侧导航与 KPI，右侧长文与数据看板，适合连续阅读。',
    accent: '#7BAE7F',
    chip: 'SPLIT/08',
    focus: '适合信息密度较高的周报阅读场景，强调“导航 + 内容流 + 进度”一体化。',
    bestFor: '综合周报 / 管理例会',
    departmentTags: ['comprehensive', 'operations', 'research', 'teaching'],
    audienceTags: ['director', 'executive', 'operations'],
    moduleBlueprint: ['左侧 KPI', '要览总览', '四类工作流', '数据看板', '签发信息'],
  },
  {
    id: 'template-09',
    renderer: 'swiss-grid',
    name: '瑞士版式版',
    title: '瑞士网格周报',
    description: '黑白红高对比网格体系，分区明确，强调结构秩序与数字可读性。',
    accent: '#CC1A1A',
    chip: 'SWISS/09',
    focus: '适合追求严谨信息层级和数字表达的管理周报。',
    bestFor: '经营复盘 / 数据汇报',
